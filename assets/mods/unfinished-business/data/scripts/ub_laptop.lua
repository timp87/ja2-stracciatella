...
function goto_webpage(page_id)
    if gubQuest[UB_Quests.QUEST_FIX_LAPTOP] == QuestStatuses.QUESTINPROGRESS then
        -- TODO: go to BROKEN_LINK if Laptop quest is in progress
        SetLaptopModes(LAPTOP_MODE_BROKEN_LINK)
    end
end